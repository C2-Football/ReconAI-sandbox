...
window.cacheLeagueData      = cacheLeagueData;
window.getCachedLeagueData  = getCachedLeagueData;
window.cachePlayers         = cachePlayers;
window.getCachedPlayers     = getCachedPlayers;
